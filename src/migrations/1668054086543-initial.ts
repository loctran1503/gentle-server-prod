...
export class initial1668054086543 implements MigrationInterface {
    name = 'initial1668054086543'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "country" ("id" SERIAL NOT NULL, "countryName" character varying NOT NULL, CONSTRAINT "UQ_d170c76512626b32fbe1673305d" UNIQUE ("countryName"), CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_kind" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_aa3c00b453ea773897dee44dcb2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_class" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "kindId" integer, CONSTRAINT "PK_d59ae9c0bc6668d8eb4568f2e27" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "brand" ("id" SERIAL NOT NULL, "brandName" character varying NOT NULL, "thumbnail" character varying NOT NULL, "description" character varying, CONSTRAINT "UQ_abb84c510fd9e50b42a6c6d332c" UNIQUE ("brandName"), CONSTRAINT "PK_a5d20765ddd942eb5de4eee2d7f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "price" ("id" SERIAL NOT NULL, "type" character varying NOT NULL, "price" integer NOT NULL, "salesPercent" integer NOT NULL DEFAULT '0', "status" integer NOT NULL, "isGift" boolean, "productId" integer, CONSTRAINT "PK_d163e55e8cce6908b2e0f27cea4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "money_bonus" ("id" SERIAL NOT NULL, "moneyNumber" bigint NOT NULL, "description" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_ba48ca981e7d4540b969c68069a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "userId" character varying NOT NULL, "userAvatar" character varying NOT NULL, "userName" character varying NOT NULL, "introduceCode" integer NOT NULL, "paidAmount" integer NOT NULL DEFAULT '0', "isHidden" boolean NOT NULL DEFAULT false, "moneyDepot" integer NOT NULL DEFAULT '0', "createdAt" date NOT NULL DEFAULT now(), CONSTRAINT "UQ_d72ea127f30e21753c9e229891e" UNIQUE ("userId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "my_event" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "content" character varying NOT NULL, "thumbnailForDesktop" character varying NOT NULL, "thumbnailForMobile" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c74a63ded281c323311482d0b5f" PRIMARY KEY ("id"))`);
