...
export class initial1652261377811 implements MigrationInterface {
    name = 'initial1652261377811'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "country" ("id" SERIAL NOT NULL, "countryName" character varying NOT NULL, "kindId" integer, CONSTRAINT "UQ_d170c76512626b32fbe1673305d" UNIQUE ("countryName"), CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "country" ADD CONSTRAINT "FK_03d7c6aa83ad76418a1ecc8314a" FOREIGN KEY ("kindId") REFERENCES "product_kind"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "country" DROP CONSTRAINT "FK_03d7c6aa83ad76418a1ecc8314a"`);
