...
class initial1651888374596 {
    ...
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`CREATE TABLE "product_kind" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_4069cd63efc6b2a43569a307396" UNIQUE ("name"), CONSTRAINT "PK_aa3c00b453ea773897dee44dcb2" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`CREATE TYPE "public"."money_bonus_type_enum" AS ENUM('Số tiền nhận', 'Số tiền đã rút')`);
            yield queryRunner.query(`CREATE TABLE "money_bonus" ("id" SERIAL NOT NULL, "moneyNumber" bigint NOT NULL, "description" character varying NOT NULL, "type" "public"."money_bonus_type_enum" NOT NULL DEFAULT 'Số tiền nhận', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_ba48ca981e7d4540b969c68069a" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "userId" character varying NOT NULL, "userAvatar" character varying NOT NULL, "userName" character varying NOT NULL, "introduceCode" integer NOT NULL, "paidAmount" integer NOT NULL DEFAULT '0', "isHidden" boolean NOT NULL DEFAULT false, "createdAt" date NOT NULL DEFAULT now(), CONSTRAINT "UQ_d72ea127f30e21753c9e229891e" UNIQUE ("userId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`ALTER TABLE "brand" ADD CONSTRAINT "FK_3c1d26849a0bf52b9bab4c63f79" FOREIGN KEY ("kindId") REFERENCES "product_kind"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "brand" DROP CONSTRAINT "FK_3c1d26849a0bf52b9bab4c63f79"`);
            ...
            yield queryRunner.query(`DROP TYPE "public"."money_bonus_type_enum"`);
