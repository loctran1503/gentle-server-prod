...
exports.initial1652451840370 = void 0;
class initial1652451840370 {
    constructor() {
        this.name = 'initial1652451840370';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`CREATE TABLE "country" ("id" SERIAL NOT NULL, "countryName" character varying NOT NULL, CONSTRAINT "UQ_d170c76512626b32fbe1673305d" UNIQUE ("countryName"), CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`CREATE TABLE "my_event" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "content" character varying NOT NULL, "thumbnailForDesktop" character varying NOT NULL, "thumbnailForMobile" character varying NOT NULL, "summary" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c74a63ded281c323311482d0b5f" PRIMARY KEY ("id"))`);
...
exports.initial1652451840370 = initial1652451840370;
//# sourceMappingURL=1652451840370-initial.js.map