...
export class initial1652451840370 implements MigrationInterface {
    name = 'initial1652451840370'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "my_event" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "content" character varying NOT NULL, "thumbnailForDesktop" character varying NOT NULL, "thumbnailForMobile" character varying NOT NULL, "summary" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c74a63ded281c323311482d0b5f" PRIMARY KEY ("id"))`);
